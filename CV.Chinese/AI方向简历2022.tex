...
\begin{minipage}[t]{0.77\textwidth}
	...
	\vspace{\topsep}
	\begin{tightemize}
		\item 改进常见的多尺度U-net结构实现适合多机并行加速的{\bfseries 分体式视频超分辨率神经网络}
		\item 对神经网络模型的中间特征进行{\bfseries 维度压缩}和{\bfseries 8bit量化}后编码为视频以便在多机间传输
	...
	\begin{tightemize}
		...
		\item 在float16量化后的网络结构中搜索并排除对精度影响较大的层，使得相对误差下降了75\%
		\item 对模型进行int8 QAT量化，在保证输出图像质量的前提下达到50\%的加速比
		\item 项目地址：\href{https://github.com/liu-mengyang/trt-elan}{github.com/liu-mengyang/trt-elan}
	\end{tightemize}
	\sectionsep
